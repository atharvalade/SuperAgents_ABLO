  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative max-w-5xl">
        ...
        >
          <h2 className="text-white text-center font-bold text-2xl md:text-3xl mb-10">
            The Impact of <span className="text-primary">View Obstruction</span>
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-darkmode/50 backdrop-blur-md border border-primary/20 rounded-xl overflow-hidden shadow-glow-sm">
              <div className="relative h-[300px]">
                <Image 
                  src="/golden_gate_unobstructed.png" 
                  alt="Unobstructed view of Golden Gate Bridge" 
                  fill
                  className="object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-white text-xl font-medium mb-2 flex items-center">
                  <Icon icon="ph:check-circle-fill" className="text-green-400 mr-2 text-xl" />
                  Unobstructed View
                </h3>
                <p className="text-muted">
                  Properties with protected air rights maintain clear views, preserving their value and desirability in the market.
                </p>
                <div className="mt-4 flex items-center">
                  <Icon icon="ph:trend-up" className="text-green-400 mr-2 text-xl" />
                  <span className="text-green-400 font-medium">+15-25% property value</span>
                </div>
              </div>
            </div>
            
            <div className="bg-darkmode/50 backdrop-blur-md border border-orange-500/20 rounded-xl overflow-hidden shadow-glow-sm">
              <div className="relative h-[300px]">
                <Image 
                  src="/golden_gate_obstructed.png" 
                  alt="Obstructed view of Golden Gate Bridge" 
                  fill
                  className="object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-white text-xl font-medium mb-2 flex items-center">
                  <Icon icon="ph:x-circle-fill" className="text-orange-400 mr-2 text-xl" />
                  Obstructed View
                </h3>
                <p className="text-muted">
                  When views become blocked by new developments, property values can significantly decrease, affecting investment returns.
                </p>
                <div className="mt-4 flex items-center">
                  <Icon icon="ph:trend-down" className="text-orange-400 mr-2 text-xl" />
                  <span className="text-orange-400 font-medium">-10-30% property value</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-10">
            <Link href="/listings" className="inline-flex items-center text-primary hover:text-primary/80 transition-colors">
              <span>Learn how air rights can protect your investment</span>
