  ...
  useEffect(() => {
    ...
    try {
      ...
      const mapInstance = new mapboxgl.Map({
        ...
        center: [-122.4785, 37.8199], // Centered on Golden Gate Bridge
        zoom: 15.5,
        pitch: 60,
        bearing: 80, // Angled to face the bridge
        antialias: true
      });
      ...
      mapInstance.on('load', () => {
        ...
        try {
          // Create data for Golden Gate Bridge area buildings with two rows
          // First row (closer to bridge) - shorter buildings
          // Second row (further from bridge) - taller buildings that need view protection
          const niagaraBuildings = [
            // First row buildings (closer to bridge)
            {
              id: 1,
              name: "Marina View Apartments",
              coordinates: [-122.4350, 37.8050] as [number, number],
            ...
            {
              id: 2,
              name: "Presidio Heights Tower",
              coordinates: [-122.4370, 37.8045] as [number, number],
            ...
            },
            {
              ...
              coordinates: [-122.4330, 37.8055] as [number, number],
            ...
            // Second row buildings (further from bridge)
            {
              id: 4,
              name: "Bay View Tower",
              coordinates: [-122.4350, 37.8020] as [number, number],
            ...
            },
            {
              ...
              coordinates: [-122.4370, 37.8015] as [number, number],
            ...
            {
              id: 6,
              name: "Chestnut Street Residences",
              coordinates: [-122.4330, 37.8025] as [number, number],
